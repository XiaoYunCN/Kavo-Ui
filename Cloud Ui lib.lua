...
function Cloudlib.new(Cloudlib, name,theme)
...
if theme == 'dark' then
    ...
    coroutine.wrap(NPLHKB_fake_script)()
      ...
      function window.Tab(window, name, icon)
        ...
        if Cloudlib.currentTab == nil then switchTab({TabIco, Tab}) end
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            local funcs = {
              SetState = function(self, state)
                if state == nil then state = not Cloudlib.flags[flag] end
                if Cloudlib.flags[flag] == state then return end
